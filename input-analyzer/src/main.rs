...
fn try_to_analyze_as_pcap() -> Result<bool, Box<dyn Error>> {
    ...
    let file_result = output::Output {
        ...
        available_streams: vec![
            ...
            StreamInfo { name: "Ethernet::etype".to_string(), possible_type: vec![StreamDataType::UINT16] },
            StreamInfo {
            ...
            StreamInfo { name: "IPv4::df".to_string(), possible_type: vec![StreamDataType::BOOL] },
            StreamInfo { name: "IPv4::mf".to_string(), possible_type: vec![StreamDataType::BOOL] },
            StreamInfo {
            ...
            StreamInfo { name: "TCP::windows_size".to_string(), possible_type: vec![StreamDataType::UINT16] },
            ...
            StreamInfo { name: "TCP::ns".to_string(), possible_type: vec![StreamDataType::BOOL] },
            StreamInfo { name: "TCP::cwr".to_string(), possible_type: vec![StreamDataType::BOOL] },
            StreamInfo { name: "TCP::ece".to_string(), possible_type: vec![StreamDataType::BOOL] },
            StreamInfo { name: "TCP::urg".to_string(), possible_type: vec![StreamDataType::BOOL] },
            StreamInfo { name: "TCP::ack".to_string(), possible_type: vec![StreamDataType::BOOL] },
            StreamInfo { name: "TCP::psh".to_string(), possible_type: vec![StreamDataType::BOOL] },
            StreamInfo { name: "TCP::rst".to_string(), possible_type: vec![StreamDataType::BOOL] },
            StreamInfo { name: "TCP::syn".to_string(), possible_type: vec![StreamDataType::BOOL] },
            StreamInfo { name: "TCP::fin".to_string(), possible_type: vec![StreamDataType::BOOL] },
